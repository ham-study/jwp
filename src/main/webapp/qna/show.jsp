                            ...
                            <c:forEach items="${answers}" var="answer">
                                <article class="article">
                                    ...
                                    <div class="article-util">
                                        <ul class="article-util-list">
                                            <li>
                                                <a class="link-modify-article" href="/api/qna/answers/update?answerId=${answer.answerId}">수정</a>
                                            </li>
                                            <li>
                                                <form class="form-delete" action="/api/qna/answers/delete" method="POST">
...
<script type="text/template" id="answerTemplate">
    <article class="article">
        ...
        <div class="article-util">
            <ul class="article-util-list">
                <li>
                    <a class="link-modify-article" href="/api/qna/answers/update/{3}">수정</a>
                </li>
                <li>
                    <form class="form-delete" action="/api/qna/answers/delete" method="POST">
